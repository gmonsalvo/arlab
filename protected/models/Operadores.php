...
class Operadores extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('celular, fijo, documento, email, usuarioId, sucursalId, userStamp, timeStamp', 'required'),
			array('usuarioId, sucursalId', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			'clientes' => array(self::HAS_MANY, 'Clientes', 'operadorId'),
