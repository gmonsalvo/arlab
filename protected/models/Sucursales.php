...
class Sucursales extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre, comisionGeneral, tasaDescuentoGeneral, tasaInversores, tasaPesificacion, diasClearing, userStamp, timeStamp', 'required'),
			...
			array('id, nombre, direccion, email, comisionGeneral, tasaDescuentoGeneral, tasaInversores, tasaPesificacion, diasClearing', 'safe', 'on'=>'search'),
		);
	}
