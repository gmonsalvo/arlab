...
{ //ponemos el periodo por defecto que seria el actual
    ...
    $model->cuentaId=Yii::app()->params['cuentaCajaMayor'];
}
if (in_array(Yii::app()->user->model->username, array('gmonsalvo','khaure')))
{
	$this->menu=array(
  		array('label'=>'Registrar Ingreso', 'url'=>array('createMayor','tipoMov'=>'1','periodo'=>$model->periodo,'cuentaId'=>Yii::app()->params['cuentaCajaMayor'])),
		array('label'=>'Registrar Egreso', 'url'=>array('createMayor','tipoMov'=>'0','periodo'=>$model->periodo,'cuentaId'=>Yii::app()->params['cuentaCajaMayor'])),
		array('label'=>'Pases de Caja', 'url'=>array('movimientosCuentasFlujoFondos/create','cuentaOrigen'=>Yii::app()->params['cuentaCajaMayor'])),
	);
}else{
