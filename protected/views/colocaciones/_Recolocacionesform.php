...
<div class="form">
    ...
    <div id="colocacionesInversor" style="display:none">
         <?php       $dataProvider = $cheques->searchChequesByEstado(Cheques::TYPE_EN_CARTERA_COLOCADO); //tipo de cheque en cartera colocado
    ...
    <?php echo CHtml::submitButton('Recolocar', array('id' => 'btnRecolocacion', 'disabled' => 'disabled')); ?>
