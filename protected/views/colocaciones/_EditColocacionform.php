...
<div class="form">
    ...
    $form = $this->beginWidget('CActiveForm', array(
        ...
        'action' => Yii::app()->createUrl("/colocaciones/realizarRecolocacion")
            ));
    ?>
    ...
    <?php echo $form->hiddenField($nuevoModel, 'chequeId', array('value'=>$cheques->id)); ?>
    ...
    <?php
    $this->renderPartial('/cheques/view', array('model' => $cheques));
    ?>
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        'id' => 'clientes-grid',
        'dataProvider' => Clientes::model()->searchInversoresParaColocacion(),
        'filter' => Clientes::model(),
