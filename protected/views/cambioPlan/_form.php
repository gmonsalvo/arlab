...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
	<?php 
		echo $form->hiddenField($model,'servicioInternetId',array('value'=>$_GET['servicioInternetId'])); 
		$cliente=ServiciosInternet::model()->findByPk($_GET['servicioInternetId']);
		?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'accion',$model->getAcciones(), array('prompt' => 'Seleccione')); ?>
		<?php echo $form->error($model,'accion'); ?>
	</div>
          <div class="row">
		<?php echo $form->labelEx($model,'periodoInicio'); ?>
		<?php echo $form->textField($model,'periodoInicio',array('size'=>10,'maxlength'=>6))." Formato Ej. 201207"; ?>
