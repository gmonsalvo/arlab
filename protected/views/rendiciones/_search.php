...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'periodoInicio'); ?>
		<?php echo $form->textField($model,'periodoInicio'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'periodoFin'); ?>
		<?php echo $form->textField($model,'periodoFin'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'cobradorId'); ?>
		<?php echo $form->textField($model,'cobradorId'); ?>
	</div>
